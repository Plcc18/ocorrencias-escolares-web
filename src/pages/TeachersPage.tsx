...
function SubjectTagInput({ value, onChange, disabled }: SubjectTagInputProps) {
  ...
  return (
    <div
      className={`min-h-[38px] w-full px-3 py-1.5 border border-input rounded-lg bg-background flex flex-wrap gap-1.5 items-center focus-within:ring-2 focus-within:ring-ring/50 transition-all ${
